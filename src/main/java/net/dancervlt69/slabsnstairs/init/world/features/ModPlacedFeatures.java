...
public class ModPlacedFeatures {
    ...
    public static final RegistryObject<PlacedFeature> CITRINE_ORE_PLACED = MOD_PLACED_FEATURES.register(
            "citrine_ore_placed", () -> new PlacedFeature(ModConfiguredFeatures.CITRINE_ORE
                    .getHolder().get(), commonOrePlacement(8, HeightRangePlacement
                    .triangle(VerticalAnchor.absolute(-80), VerticalAnchor.absolute(60)))));
...
//                    PlacementUtils.countExtra(3,0.1f, 2)))); */
    ...
    public static final ResourceKey<PlacedFeature> CITRINE_ORE = PlacementUtils.createKey("citrine_ore");
