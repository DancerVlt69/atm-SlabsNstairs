...
//    static {
//        CITRINE = (ForgeTier) TierSortingRegistry.registerTier(
//                new ForgeTier(5, 2200, 1.2f, 3f, 24,
//                        ModBlockTags.NEEDS_NETHERITE_TOOL, () -> Ingredient.of(ModItems.CITRINE.get())),
//                new ResourceLocation(MODID, "citrine"), List.of(Tiers.NETHERITE), List.of());
//    }
}
