...
public class ModBlocks {
   public static final DeferredRegister<Block> MOD_BLOCKS =
    ...
    public static final RegistryObject<Block> GROWTH_STOP = registerBlock("growth_stop",
            () -> new ChainBlock(BlockBehaviour.Properties.of(Material.BUILDABLE_GLASS)
                    .sound(SoundType.GLASS).strength(0.5F).noCollission()),
...
/*    public static final RegistryObject<Block> TEST_BLOCK = registerBlock("test_block",
    ...
    public static final RegistryObject<Block> CITRINE_ORE = registerBlock("citrine_ore",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.GOLD_ORE)
                    .sound(SoundType.STONE).strength(4.0f).requiresCorrectToolForDrops()){});

    public static final RegistryObject<Block> DEEPSLATE_CITRINE_ORE = registerBlock("deepslate_citrine_ore",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.DEEPSLATE_GOLD_ORE)
                    .sound(SoundType.DEEPSLATE).strength(4.75f).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> CITRINE_BLOCK = registerBlock("citrine_block",
            () -> new Block(BlockBehaviour.Properties.of(Material.METAL)
                    .sound(SoundType.METAL).strength(5.5f).requiresCorrectToolForDrops()),
    ...
    public static final RegistryObject<Block> CITRINE_SLAB = registerBlock("citrine_slab",
            () -> new SlabBlock(BlockBehaviour.Properties.of(Material.METAL)
                    .sound(SoundType.METAL).strength(5.5f)));
    public static final RegistryObject<Block> CITRINE_BUTTON = registerBlock("citrine_button",
            () -> new ButtonBlock(BlockBehaviour.Properties.of(Material.METAL)
                    ...
                    .noCollission(), 20, false, SoundEvents.STONE_BUTTON_CLICK_OFF,
                    SoundEvents.STONE_BUTTON_CLICK_ON));

    public static final RegistryObject<Block> CITRINE_PRESSURE_PLATE = registerBlock("citrine_pressure_plate",
            () -> new WeightedPressurePlateBlock(15, BlockBehaviour
                    .Properties.of(Material.METAL, MaterialColor.GOLD).strength(0.5F)
                    .sound(SoundType.METAL), SoundEvents.STONE_PRESSURE_PLATE_CLICK_OFF,
                    SoundEvents.STONE_PRESSURE_PLATE_CLICK_ON));

    // Prismarine
    public static final RegistryObject<Block> PRISMARINE_BUTTON = registerBlock("prismarine_button",
            () -> new ButtonBlock(BlockBehaviour.Properties.of(Material.STONE)
                    .sound(SoundType.STONE).strength(0.5f).noCollission(),
                    20, false, SoundEvents.STONE_BUTTON_CLICK_OFF,
                    SoundEvents.STONE_BUTTON_CLICK_ON));
    ...
    public static final RegistryObject<Block> PRISMARINE_BRICK_WALL = registerBlock ("prismarine_brick_wall",
            () -> new WallBlock(BlockBehaviour.Properties.of(Material.STONE)
                    .sound(SoundType.STONE).strength(0.5f, 6.0f)));
    ...
    public static final RegistryObject<Block> CINNAMON_HANGING_SIGN = registerBlockNoItem("cinnamon_hanging_sign",
            () -> new ModHangingSignBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE)
                    .noCollission().strength(1.0f).sound(SoundType.HANGING_SIGN)
                    .requiredFeatures(FeatureFlags.VANILLA), ModWoodTypes.CINNAMON));
    public static final RegistryObject<Block> CINNAMON_WALL_HANGING_SIGN = registerBlockNoItem("cinnamon_wall_hanging_sign",
            () -> new ModWallHangingSignBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE)
                    .noCollission().strength(1.0f).sound(SoundType.HANGING_SIGN)
                    .dropsLike(CINNAMON_HANGING_SIGN.get()).requiredFeatures(FeatureFlags.VANILLA),
                    ModWoodTypes.CINNAMON));
...
/*    public static final RegistryObject<Block> GRASS_BLOCK_STAIRS = registerBlock("grass_block_stairs",
     ...
     * @see ModBlockRegistering RegisteringModBlocks</p>*/
