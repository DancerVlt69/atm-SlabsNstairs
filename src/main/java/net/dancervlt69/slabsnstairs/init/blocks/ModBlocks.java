...
/*    public static final RegistryObject<Block> GRASS_BLOCK_STAIRS = registerBlock("grass_block_stairs",
    ...
    public static final RegistryObject<Block> DRY_ICE_BLOCK = registerBlock("dry_ice_block",
            () -> new ModDryIceBlock(BlockBehaviour.Properties.copy(Blocks.ICE)
                    .sound(SoundType.GLASS).strength(1.8f).friction(1.0F).requiresCorrectToolForDrops()
                    .lightLevel((lightLevel) -> ModClientConfig.ILLUMINATED_GROWTH_STOP_LIGHT_RANGE.getDefault())),
