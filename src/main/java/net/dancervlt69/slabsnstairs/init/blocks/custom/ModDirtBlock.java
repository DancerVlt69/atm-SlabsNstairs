...
public class ModDirtBlock extends GrassBlock {
    public ModDirtBlock(Properties pProperties) { super(pProperties); }

    @Override
    public boolean isValidBonemealTarget(LevelReader pLevel, BlockPos pPos, BlockState pState, boolean pBoolean) {
        return super.isValidBonemealTarget(pLevel, pPos, pState, pBoolean);
    }
        ...
        for(int i = 0; i < 128; ++i) {
            ...
            if (blockstate1.isAir()) {
                ...
                if (pRandom.nextInt(8) == 0) {
                    ...
                    holder = (Holder<PlacedFeature>) VegetationPlacements.GRASS_BONEMEAL;
                }
