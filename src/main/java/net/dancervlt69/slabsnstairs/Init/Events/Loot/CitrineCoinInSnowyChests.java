...
public class CitrineCoinInSnowyChests extends LootModifier {
    ...
    protected CitrineCoinInSnowyChests(ILootCondition[] conditionsIn, Item item) {
        super(conditionsIn);
        this.item = item;
    }
    ...
    public static class Serializer extends GlobalLootModifierSerializer<CitrineCoinInSnowyChests> {
        @Override
        public CitrineCoinInSnowyChests read(ResourceLocation name, JsonObject object, ILootCondition[] conditionIn) {
