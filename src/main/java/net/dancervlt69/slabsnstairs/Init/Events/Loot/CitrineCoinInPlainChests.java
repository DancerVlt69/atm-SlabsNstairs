...
public class CitrineCoinInPlainChests extends LootModifier {
    ...
    protected CitrineCoinInPlainChests(ILootCondition[] conditionsIn, Item item) {
        super(conditionsIn);
        this.item = item;
    }
    ...
    public static class Serializer extends GlobalLootModifierSerializer<CitrineCoinInPlainChests> {
        @Override
        public CitrineCoinInPlainChests read(ResourceLocation name, JsonObject object, ILootCondition[] conditionIn) {
