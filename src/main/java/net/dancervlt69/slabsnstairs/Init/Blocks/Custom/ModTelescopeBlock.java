...
public class ModTelescopeBlock extends Block {

    public static final int USE_DURATION = 2400;
    public static final float ZOOM_FOV_MODIFIER = 0.25F;

    public ModTelescopeBlock(BlockBehaviour.Properties pProperties) {
        super(pProperties);
    }
