package net.dancervlt69.slabsnstairs.core.lang;
...
public @interface Deprecated {
     ...
     *  deprecated. The version string is in the same format and
     *  namespace as the value of the @since javadoc tag.
    ...
    /**
     *  Indicates whether the annotated element is subject
